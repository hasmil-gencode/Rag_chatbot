    ...
    <>
      ...
      <div 
        ...
        onClick={() => {
          ...
          document.getElementById('mobile-chat-menu')?.classList.add('hidden');
        }}
      >
        ...
        <div className="md:hidden fixed top-0 left-0 right-0 z-[50] bg-background border-b border-border">
          <div className="flex items-center justify-between px-3 py-2">
            ...
            <div className="relative">
              ...
              <div 
                id="mobile-chat-menu"
                className="hidden absolute right-0 top-full mt-1 w-48 bg-popover border border-border rounded-md shadow-lg z-[60]"
